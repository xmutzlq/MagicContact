...
public class WaveSideBarView extends View {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs != null) {
			...
			mRadius = a.getInt(R.styleable.WaveSideBarView_sidebarRadius,
					context.getResources().getDimensionPixelSize(R.dimen.radius_sidebar));
			mBallRadius = a.getInt(R.styleable.WaveSideBarView_sidebarBallRadius,
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			mCenterY = Math.max(mBallRadius + (int) mTextSize / 2,
					Math.min(mHeight - mBallRadius - (int) mTextSize / 2, (int) y));
