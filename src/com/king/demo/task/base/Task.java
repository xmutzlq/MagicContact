...
public class Task<TResult> {
  ...
  public static <TResult> Task<TResult> forResult(TResult value) {
    ...
    com.king.demo.task.base.TaskCompletionSource<TResult> tcs = 
    		new com.king.demo.task.base.TaskCompletionSource<TResult>();
    tcs.setResult(value);
    return tcs.getTask();
  }
  ...
  public static <TResult> Task<TResult> forError(Exception error) {
	  com.king.demo.task.base.TaskCompletionSource<TResult> tcs = new com.king.demo.task.base.TaskCompletionSource<TResult>();
    tcs.setError(error);
    return tcs.getTask();
  }
  ...
  /* package */ static Task<Void> delay(long delay, ScheduledExecutorService executor, final CancellationToken cancellationToken) {
    ...
    final com.king.demo.task.base.TaskCompletionSource<Void> tcs = 
    		new com.king.demo.task.base.TaskCompletionSource<Void>();
  ...
  public static <TResult> Task<TResult> call(final Callable<TResult> callable, Executor executor,
    ...
    final com.king.demo.task.base.TaskCompletionSource<TResult> tcs = 
    		new com.king.demo.task.base.TaskCompletionSource<TResult>();
    try {
  ...
  public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> tasks) {
    ...
    final com.king.demo.task.base.TaskCompletionSource<Task<TResult>> firstCompleted = 
    		new com.king.demo.task.base.TaskCompletionSource<Task<TResult>>();
  ...
  public static Task<Task<?>> whenAny(Collection<? extends Task<?>> tasks) {
    ...
    final com.king.demo.task.base.TaskCompletionSource<Task<?>> firstCompleted = 
    		new com.king.demo.task.base.TaskCompletionSource<Task<?>>();
    final AtomicBoolean isAnyTaskComplete = new AtomicBoolean(false);
  ...
  public static Task<Void> whenAll(Collection<? extends Task<?>> tasks) {
    ...
    final com.king.demo.task.base.TaskCompletionSource<Void> allFinished = 
    		new com.king.demo.task.base.TaskCompletionSource<Void>();
  ...
  public <TContinuationResult> Task<TContinuationResult> continueWith(
      ...
      final CancellationToken ct) {
    boolean completed;
    final com.king.demo.task.base.TaskCompletionSource<TContinuationResult> tcs = 
    		new com.king.demo.task.base.TaskCompletionSource<TContinuationResult>();
    synchronized (lock) {
   ...
   * @deprecated Please use {@link bolts.TaskCompletionSource} instead.
   */
  public class TaskCompletionSource extends com.king.demo.task.base.TaskCompletionSource<TResult> {
  ...
  private static Task<Boolean> TASK_TRUE = new Task<Boolean>((Boolean) true);
  private static Task<Boolean> TASK_FALSE = new Task<Boolean>((Boolean) false);
